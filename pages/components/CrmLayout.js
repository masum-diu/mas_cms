        ...
        <Box sx={{ width: "98%", maxWidth: "1500px", margin: "0 auto" }}>
            <Stack direction="row" spacing={2.5} sx={{ mt: 2 }}>
                ...
                <List sx={{
                    ...
                    {/* Logo */}
                    <Stack direction="column" spacing={1} justifyContent="center" alignItems={"center"} mb={2}>
                        <img src="/maslogo.png" alt="Logo" width={100} />
                        <Typography fontSize={12} className='light' textAlign={"center"} sx={{  color: '#fff' }}>
                    ...
                    {menuItems.map((item, index) => (
                        <ListItem
                            ...
                            sx={{
                                ...
                                borderRadius: '12px',
                                mb: 1,
                                backgroundColor: isSelected(item.id) ? '#940f25' : 'transparent',
                                '&:hover': {
                                    backgroundColor: isSelected(item.id) ? '#940f25' : 'rgba(255, 255, 255, 0.1)',
                                },
                            }}
                        ...
                        >
                            ...
                            <ListItemText
                                primary={
                                    <Typography className={isSelected(item.id) ? "light" : "Medium"} style={{ fontSize: 14 }}>
                                        {item.text}
                                    </Typography>
                                }
                            />
